    ...
    <body>
                    ...
                    <ul class="top-menu">
                                ...
                                <div class="listview">
                                    ...
                                    <div class="lv-body">
                                        <a class="lv-item" href="">
                                            <div class="media">
                                                <div class="pull-left">
                                                    <img class="lv-img-sm" src="{{URL::to('assets')}}/img/profile-pics/1.jpg" alt="">
                                                </div>
                                        ...
                                        <a class="lv-item" href="">
                                            <div class="media">
                                                <div class="pull-left">
                                                    <img class="lv-img-sm" src="{{URL::to('assets')}}/img/profile-pics/2.jpg" alt="">
                                                </div>
                                                <div class="media-body">
                                        ...
                                        <a class="lv-item" href="">
                                            <div class="media">
                                                <div class="pull-left">
                                                    <img class="lv-img-sm" src="{{URL::to('assets')}}/img/profile-pics/3.jpg" alt="">
                                                </div>
                                                <div class="media-body">
                                        ...
                                        <a class="lv-item" href="">
                                            <div class="media">
                                                <div class="pull-left">
                                                    <img class="lv-img-sm" src="{{URL::to('assets')}}/img/profile-pics/4.jpg" alt="">
                                                </div>
                                                <div class="media-body">
                        ...
                        <li class="dropdown">
                            <a data-toggle="dropdown" href="">
                                ...
                                {{-- */$count = App\CountNotification::findorFail(Auth::user()->uid)->count;/* --}}
                                @if($count != 0)
                            ...
                            <div class="dropdown-menu dropdown-menu-lg pull-right">
                                <div class="listview" id="notifications">
                                    ...
                                    <div class="lv-body">
                                        ...
                                        @else
                                            {{-- */$name = App\Notification::where('uid', Auth::user()->uid)
                                                           ->orderBy('id', 'desc')
                                                           ->take($count)
                                                           ->get();/* --}}
                                            @foreach($name as $x)
                                                <a class="lv-item" href="">
                                                    <div class="media">
                                                        ...
                                                        <div class="media-body">
                                                            <div class="lv-title"><B>{{$x->name}}</B> has made a booking.</div>
                                                        </div>
                                                    </div>
                                                </a>
                                            @endforeach
        ...
        <section id="main" data-layout="layout-1">
            <aside id="sidebar" class="sidebar c-overflow">
                ...
                <ul class="main-menu">
                    <li class="active">
                        <a href="{{URL::to('/')}}"><i class="zmdi zmdi-home"></i> Home</a>
                    </li>
                    <li class="sub-menu">
                    ...
                    <li><a href="booking"><i class="zmdi zmdi-format-underlined"></i> Register Booking</a></li>
                    <li><a href="create"><i class="zmdi zmdi-format-underlined"></i>Create Member Account</a></li>
                    <li><a href="show"><i class="zmdi zmdi-format-underlined"></i>Show all Bookings</a></li>
            ...
            <aside id="chat" class="sidebar c-overflow">
                ...
                <div class="listview">
                    ...
                    <a class="lv-item" href="">
                        <div class="media">
                            <div class="pull-left">
                                <img class="lv-img-sm" src="{{URL::to('assets')}}/img/profile-pics/5.jpg" alt="">
                            </div>
                            <div class="media-body">
                                <div class="lv-title">Bill Phillips</div>
                    ...
                    <a class="lv-item" href="">
                        <div class="media">
                            <div class="pull-left">
                                <img class="lv-img-sm" src="{{URL::to('assets')}}/img/profile-pics/6.jpg" alt="">
                            </div>
                            <div class="media-body">
                    ...
                    <a class="lv-item" href="">
                        <div class="media">
                            <div class="pull-left p-relative">
                                <img class="lv-img-sm" src="{{URL::to('assets')}}/img/profile-pics/7.jpg" alt="">
                                <i class="chat-status-busy"></i>
                            </div>
                            <div class="media-body">
